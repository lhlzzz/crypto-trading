...
def get_trading_status() -> dict[str, Any]:
    ...
    return {
        ...
        "CODE_READY": True,
        "REAL_DATA_READY": gate.observation_gate_status == "PASSED",
        "PAPER_READY": gate.paper_ready,
        "SHADOW_READY": gate.shadow_gate_status == "PASSED",
        "TESTNET_READY": gate.testnet_ready,
        "ALPHA_STATUS": gate.alpha_gate_status,
        "LIVE_PREFLIGHT": gate.live_ready,
        "LIVE_ALLOWED": gate.live_allowed,
        "data_health": gate.data_health,
        "orderbook_health": gate.current_orderbook,
        "account_health": gate.current_account_health,
