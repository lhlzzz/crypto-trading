...
def _trading_store_stub():
    return type(
        ...
        (),
        {
            ...
            "is_halted": lambda self, mode=None, market="FUTURES": False,
...
def test_trading_api_is_read_only_and_exposes_status() -> None:
    store = type(
        ...
        (),
        {
            ...
            "list_orders": lambda self, limit, mode=None, market="FUTURES": [{"status": "FILLED", "limit": limit}],
            "list_trades": lambda self, limit, mode=None, market="FUTURES": [{"symbol": "BTCUSDT", "limit": limit}],
            "list_positions": lambda self, mode=None, market="FUTURES": [{"symbol": "BTCUSDT"}],
            "list_balances": lambda self, mode=None: [{"asset": "USDT", "free": "1000"}],
            "list_risk_events": lambda self, limit, mode=None, market="FUTURES": [{"decision": "ALLOW", "limit": limit}],
            "list_system_events": lambda self, limit, mode=None, market="FUTURES": [{"event_type": "SYSTEM_EVENT", "limit": limit}],
            "trading_summary": lambda self, mode=None: {"account_equity_usdt": "1000", "total_pnl": "0"},
            "is_halted": lambda self, mode=None, market="FUTURES": False,
        },
    )
